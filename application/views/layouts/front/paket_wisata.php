 <section class="background-grey-1 padding-tb-25px text-grey-4">
     ...
     <!-- pencarian -->
        <div class="row justify-content-md-center">
            <a href="<?php echo site_url('booking/carapesan'); ?>" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i>Cara Pemesanan</a>
            <div class="col-lg-5 text-center">

            <form class="input-group input-group-lg" class="form-inline" action="<?php echo site_url('Paket_wisata/cari');?>" method="get">
                <input type="text" class="form-control" placeholder="Pencarian Paket Wisata" aria-label="Text input with dropdown button" name="cari">
                        ...
                        <div class="padding-20px">
                            ...
                            <div class="margin-bottom-8px  text-extra-small">
                                <strong class="text-medium text-third-color padding-right-5px font-weight-bold">
                                    <?php echo 'Rp. '.number_format($p->harga, 2,',','.') ?> /pax</strong>
                            </div>
