...
<div class="col-md-12">
        <div class="box" >
            <div class="box-header">
              <?php echo form_open('admin/L_Tourguide'); ?>
        ...
        <div class="box" style="padding: 20px">
            <div class="box-header">
                <h3 class="box-title">Laporan Tour Guide</h3>
                <div class="box-tools">
                   <form class="form-inline" action="" method="post">
                        <div class="form-group">
                            <a href="<?php echo site_url('admin/l_tourguide/cetak/'); ?>" class="btn btn-success" target="_blank"><i class="fa fa-print"></i></a>
                        </div>
            ...
            <div class="box-body" >
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><center>
                        <?php
                            $guide = $this->Pemesanan_tourguide_model->laporanfilterguide($g['id_tourguide'],$bulan,$tahun);
                            echo count($guide);
                        ?>
                        </center></td>
