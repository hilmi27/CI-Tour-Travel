...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Konfirmasi Pemesanan Paket</li>
      </ol>
    </div>
    </section>
<!-- <div class="col-md-12">
...
<div class="col-md-12">
        <div class="box" >
            <div class="box-header">
              <?php echo form_open('admin/Konfirmasi_p'); ?>
            ...
            <div class="box-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <!-- <td style="vertical-align:middle;text-align:center"><center><?php echo $kp->nama ?></center></td> -->
                        <td><center>
