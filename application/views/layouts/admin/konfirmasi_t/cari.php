...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Konfirmasi Pemesanan Tour Guide</li>
      </ol>
    </div>
    </section>
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <a href="<?php echo site_url('admin/konfirmasi_t/index'); ?>" class="btn btn-danger"><i class="fa fa-arrow-circle-left"></i> Kembali</a> 
            	<div class="box-tools">
            ...
            <div class="box-body">
                <table class="table table-striped  table-hover">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;text-align:center"><center>
                            <!-- <a href="<?php echo site_url('admin/konfirmasi_t/show/'.$kp->id_konfirmasi); ?>" class="btn btn-success btn-xs"><span class="fa fa-tv"></span> Show</a> -->
