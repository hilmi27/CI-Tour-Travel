...
<div class="col-md-12">
        <div class="box" >
            <div class="box-header">
              <?php echo form_open('admin/Pemesanan_guide'); ?>
            ...
            <div class="box-body">
                <table class="table table-striped table-bordered">
                    <tr style="background-color:#ccc;">
                        ...
                        <th width="5px"><center> Invoice</center></th>
                        <th width="7px"><center> Tanggal Pemesanan</center></th>
                        <th width="15px"><center> Nama</center></th>
                        <th width="25px"><center> Alamat</center></th>
                        <th width="10px"><center> Tour Guide</center></th>
                        <th width="15px"><center> Harga</center></th>
						<th width="15px"><center> Status</center></th>
						<th width="5px"><center>Opsi</center></th>
                    </tr>
                    ...
                    <tr>
						...
						<td><center>
                            <a href="<?php echo site_url('admin/Pemesanan_guide/show/'.$p->id_pemesananguide) ?>" class="btn btn-success btn-xs"><span class="fa fa-eye" ></span> </a> 
                            <!-- <a href="<?php echo site_url('admin/pemesanan_guide/edit/'.$p->id_pemesananguide) ?>" class="btn btn-info btn-xs"><span class="fa fa-edit"></span> </a> -->
                            <a href="<?php echo site_url('admin/pemesanan_guide/remove/'.$p->id_pemesananguide) ?>" class="btn btn-danger btn-xs" onclick="return confirm ('Apakah Anda Yakin ?')"><span class="fa fa-trash"></span> </a>
                        </center></td>
                    </tr>
                    <?php } ?>
                    <?php 
