        ...
        <?php echo '
              <table cellpadding="0" cellspacing="0" border="1" width="100%">
                ...
                <tr >
                  ...
                  <td><center>'.$paket->nama_paketwisata.'</center></td>
                  <td><center>'.$show->jumlah_anggota.' pax</center><td>
                  <td><center>'.'Rp. '.number_format($paket->harga*$show->jumlah_anggota, 2,',','.').'</center></td>
                </tr>
