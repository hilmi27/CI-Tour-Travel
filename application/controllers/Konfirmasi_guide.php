...
class Konfirmasi_guide extends CI_Controller{
    ...
    function index()
    {
        ...
        $data['_view'] = 'layouts/front/konfirmasi_guide';
        ...
        {   
            ...
            $tgl =  date('Y-m-d');
                ...
                if(count($cekinvoice) >= 1){
                    ...
                    $pemesanan_tourguide = $this->Pemesanan_tourguide_model->update_pemesanan_tourguide($cekinvoice->id_pemesanan,$data_pemesanan);

                    $konfirmasi_p_id = $this->Konfirmasi_p_model->add_konfirmasi_p($params);
                    redirect('validasi_paket');
                }else {
                redirect('Konfirmasi_guide');
                    }
        }
        else
        {            
